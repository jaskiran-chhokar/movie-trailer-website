...
the_imitation_game = media.Movie("The Imitation Game",
                                 "During World War II, the English mathematical genius"
                                 "Alan Turing tries to crack the German Enigma code with"
...
titanic = media.Movie("Titanic",
                      ...
                      "love with a kind but poor artist aboard" 
...
harry_potter = media.Movie("The Prisoner of Azkaban",
                           "It's Harry's third year at Hogwarts; not only"
                           "does he have a new Defense Against the Dark"
                           "Arts teacher, but there is also trouble"
                           "brewing. Convicted murderer Sirius Black has"
                           "escaped the Wizards' Prison and is coming"
                           "after Harry.",
...
forrest_grump = media.Movie("Forrest Grump",
                            "Forrest Gump is a 1994 film starring Tom Hanks"
                            "and directed by Robert Zemeckis. It is based"
                            "on the 1986 novel of the same name by Winston"
                            "Groom.",
                            "http://www.movienewsletters.net/photos/000014R1.jpg",
                            "https://www.youtube.com/watch?v=uPIEn0M8su0")

the_theory_of_everything = media.Movie("The Theory of Everything",
                                       "The Theory of Everything is the extraordinary"
                                       "true story of one of the world's greatest living"
                                       "minds, the renowned astrophysicist Stephen"
